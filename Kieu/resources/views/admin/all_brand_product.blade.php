        ...
        @foreach($all_brand_product as $key => $brand_pro)
          <tr>
            ...
            <td>
                ...
                <a onclick="return confirm('Bạn chắc chắn muốn xóa thương hiệu này không?')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">

                            ...
                            @foreach($edit_brand_product as $key => $edit_value)
                                ...
                                <div class="position-center">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <input type="text" name="slug_brand_product" class="form-control" id="convert_slug" placeholder="Tên danh mục">
                                    </div> --}}
                                    <div class="form-group">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <textarea style="resize: none" rows="8" class="form-control" name="brand_product_keywords" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                                    </div> --}}

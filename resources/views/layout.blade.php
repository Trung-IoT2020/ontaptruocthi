					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0326492427</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> ltlkieu1207@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{('public/fontend/images/logotx.png')}}" alt="" /></a>
						</div>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{('public/fontend/images/txava.jpg')}}" height="100px" width="100px" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{('public/fontend/images/txchanel.jpg')}}" height="200px" width="100px" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{'public/fontend/images/txlemino1.jpg'}}" height="200px" width="100px" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{('public/fontend/images/tuixachle22067.jpg')}}" height="200px" width="100px" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="{{('public/fontend/images/txquangchau.jpg')}}" height="200px" width="100px" alt="" />
